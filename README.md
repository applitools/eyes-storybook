...
| `puppeteerOptions`        | undefined                | Options to send to `puppeteer.launch`. This is a low-level configuration and should be used with great care. Example use `{ args: ['--no-sandbox']}` |
